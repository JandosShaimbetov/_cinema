...
from movie.models import Room, Showtime
...
class Discount(models.Model):
    ...
    discount_card = models.DecimalField(max_digits=9, decimal_places=2, default=0)
...
class Reservation(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.ticket_type.name == "ADULT" or self.ticket_type.name == "CHILD":
